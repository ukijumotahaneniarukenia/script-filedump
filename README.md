...
$ perl -C -M'String::Random' -M'Class::MOP' -M'Class::MOP::Class' -M'Class::Inspector' -E '$,="\t";my $meta = Class::MOP::Class->initialize("String::Random");map{%a=%{$_};map{if($_=~/associated_metaclass/){say $_,1}else{say $_,0}}sort keys %a}sort $meta->get_all_methods();'
associated_metaclass	1
body	0
name	0
original_method	0
package_name	0
...
$ perl -C -M'String::Random' -M'Class::MOP' -M'Class::MOP::Class' -M'Class::Inspector' -E 'my $meta = Class::MOP::Class->initialize("Class::MOP::Class");map{%a=%{$_};map{say $_,$a{$_}}sort keys %a}$meta->get_all_attributes();'
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbceb548)
associated_methodsARRAY(0x55cadbceba10)
builder
clearer
defaultClass::MOP::Instance
definition_contextHASH(0x55cadbceb158)
init_arginstance_metaclass
initializer
insertion_order1
nameinstance_metaclass
predicate
readerHASH(0x55cadbceb230)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadb86dbb0)
associated_methodsARRAY(0x55cadb85b468)
builder
clearer
defaultCODE(0x55cadbca4a38)
definition_contextHASH(0x55cadbca4840)
init_arg_methods
initializer
insertion_order0
name_methods
predicate
readerHASH(0x55cadb86d988)
writer
accessorHASH(0x55cadbceafd8)
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbceb548)
associated_methodsARRAY(0x55cadbcebc20)
builder
clearer
defaultCODE(0x55cadbcaf3b8)
definition_contextHASH(0x55cadbce9190)
init_arg
initializer
insertion_order0
namesuperclasses
...
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbceb548)
associated_methodsARRAY(0x55cadbcef630)
builder
clearer
defaultClass::MOP::Method::Constructor
definition_contextHASH(0x55cadbceefa0)
init_argconstructor_class
initializer
insertion_order4
nameconstructor_class
predicate
readerHASH(0x55cadbceef58)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbce9130)
associated_methodsARRAY(0x55cadbceb518)
builder
clearer
defaultCODE(0x55cadbcaf220)
definition_contextHASH(0x55cadbce8ea8)
init_arg
initializer
insertion_order1
nameauthority
predicate
readerHASH(0x55cadbce4a08)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbcdffc0)
associated_methodsARRAY(0x55cadbce0a70)
builder
clearer
defaultClass::MOP::Attribute
definition_contextHASH(0x55cadb85b3d8)
init_argattribute_metaclass
initializer
insertion_order1
nameattribute_metaclass
predicate
readerHASH(0x55cadbce0050)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbce9130)
associated_methodsARRAY(0x55cadbceb200)
builder
clearer
defaultCODE(0x55cadbcaf088)
definition_contextHASH(0x55cadb85afa0)
init_arg
initializer
insertion_order0
nameversion
predicate
readerHASH(0x55cadbce4528)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbceb548)
associated_methodsARRAY(0x55cadbcef2a0)
builder
clearer
definition_contextHASH(0x55cadbcefc78)
init_argdestructor_class
initializer
insertion_order5
namedestructor_class
predicate
readerHASH(0x55cadbcef078)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbce4258)
associated_methodsARRAY(0x55cadbce4978)
builder
clearer_clear_overload_map
defaultCODE(0x55cadbcaec20)
definition_contextHASH(0x55cadbce0cc8)
init_arg_overload_map
initializer
insertion_order0
name_overload_map
predicate
readerHASH(0x55cadbce0aa0)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadb86dbb0)
associated_methodsARRAY(0x55cadbc186d8)
builder
clearer
defaultClass::MOP::Method
definition_contextHASH(0x55cadbbbdca8)
init_argmethod_metaclass
initializer
insertion_order1
namemethod_metaclass
predicate
readerHASH(0x55cadb86f1f8)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbce4960)
associated_methodsARRAY(0x55cadbce9178)
builder
clearer
defaultCODE(0x55cadbcaeef0)
definition_contextHASH(0x55cadbce8dd0)
init_arg
initializer
insertion_order1
namenamespace
predicate
readerHASH(0x55cadbce4990)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbceb548)
associated_methodsARRAY(0x55cadbcef9f0)
builder
clearer
defaultnew
definition_contextHASH(0x55cadbcebc38)
init_argconstructor_name
initializer
insertion_order3
nameconstructor_name
predicate
readerHASH(0x55cadbcebc80)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbceb548)
associated_methodsARRAY(0x55cadbcefd38)
builder
clearer
defaultClass::MOP::Class::Immutable::Trait
definition_contextHASH(0x55cadbcebc50)
init_argimmutable_trait
initializer
insertion_order2
nameimmutable_trait
predicate
readerHASH(0x55cadbceb9f8)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbcdffc0)
associated_methodsARRAY(0x55cadbce0cb0)
builder
clearer
defaultCODE(0x55cadbcae908)
definition_contextHASH(0x55cadb85b480)
init_argattributes
initializer
insertion_order0
nameattributes
predicate
readerHASH(0x55cadb85b4b0)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadb86dbb0)
associated_methodsARRAY(0x55cadbce0650)
builder
clearer
defaultClass::MOP::Method::Wrapped
definition_contextHASH(0x55cadb85b438)
init_argwrapped_method_metaclass
initializer
insertion_order2
namewrapped_method_metaclass
predicate
readerHASH(0x55cadb85b138)
writer
accessor
associated_classClass::MOP::Class::Immutable::Class::MOP::Class=HASH(0x55cadbce4960)
associated_methodsARRAY(0x55cadbce8ed8)
builder
clearer
definition_contextHASH(0x55cadbce0bf0)
init_argpackage
initializer
insertion_order0
namepackage
predicate
readerHASH(0x55cadbcd8bb0)
writer
